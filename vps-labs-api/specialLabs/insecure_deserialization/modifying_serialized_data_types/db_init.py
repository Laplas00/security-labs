...
for title, content, author in posts:
    c.execute("INSERT OR IGNORE INTO posts (title, content, author, for_comments) VALUES (?, ?, ?, ?)", (title, content, author, False))
c.execute("INSERT OR IGNORE INTO posts (title, content, author, for_comments) VALUES (?, ?, ?, ?)", ('Post title', 'Hello world', 'testuser', True))
